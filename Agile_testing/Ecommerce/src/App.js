    ...
    <div className="App">
      ...
      <h2 id="shop">Featured Products</h2>
        <section className="products">
          ...
          <div className="product1">
            ...
            <h3> Fossil watch</h3>
            <p id="cost1">₹15000</p>
            <button id="add1" onClick={addcart}>Add to Cart</button>
          </div> <br /> <br />
          <div className="product2">
            ...
            <h3>Nike Sneakers</h3>
            <p id="cost2">₹12000</p>
            <button id="add2" onClick={addcart}>Add to Cart</button>
          </div> <br /> <br />
          <div className="product3">
            ...
            <h3>Puma Flipflop</h3>
            <p id="cost3">₹1500</p>
            <button id="add3" onClick={addcart}>Add to Cart</button>
          </div> <br /> 
          ...
          <div className="product4">
            ...
            <p id="cost4">₹1500</p>
            <button id="add4" onClick={addcart}>Add to Cart</button>
          </div>
        ...
        <div className="product5">
            ...
            <p id="cost5">₹1300</p>
            <button id="add5" onClick={addcart}>Add to Cart</button>
          </div>
          ...
          <div className="product6">
            ...
            <p id="cost6">₹500</p>
            <button id="add6" onClick={addcart}>Add to Cart</button>
          </div>
          <div className="product7">
            ...
            <p id="cost7">₹35000</p>
            <button id="add7" onClick={addcart}>Add to Cart</button>
          </div>
          <div className="product8">
            ...
            <h3>Laptop Bag</h3>
            <p id="cost8">₹3500</p>
            <button id="add8" onClick={addcart}>Add to Cart</button>
          </div>
      ...
      <h2 id="contact">Contact Us</h2>
        ...
        <label>
         ...
         <br></br>
         <button type="submit" class="btn" onClick={submitbutton}>Submit </button>
       </form>
       </div>
      <footer>
